...
stage_mirvkbuntu_source(){
  ...
  printf '%s\n'     "MIRVKBUNTU_SOURCE_REPOSITORY=mearvk/MirvkBuntu"     "MIRVKBUNTU_SOURCE_ROOT=/opt/mirvkbuntu/source"     "MIRVKBUNTU_AUTHORITATIVE=true"     "MIRVKBUNTU_BASE_DISTRIBUTION=${UBUNTU_SUITE}"     "MIRVKBUNTU_BUILD_ARCH=${ARCH}"     > "${work_dir}/config/includes.chroot/etc/mirvkbuntu/source.conf"
}
